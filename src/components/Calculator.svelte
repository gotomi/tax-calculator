<script lang="ts">
    ...
    let authorTaxDeductibleCostPercent = 0;
    let grossSalaryPerMonth = 0;
    let employerKeys = [
        "month",
        "grossSalaryPerMonth",
        "pension",
    ...
    let ppkEmployeePercent = 2;
    let ppkEmployerPercent = 1.5;

    $: grossOverTheYear = Array(12).fill(Number(grossSalaryPerMonth));
    $: authorTaxDeductibleCostRatio = authorTaxDeductibleCostPercent / 100;
    $: ppkEmployeeRatio = ppkEmployeePercent / 100;
    $: ppkEmployerRatio = ppkEmployerPercent / 100;

    let yearSalaryEmployee = grossToNetWithTotal(
        Array(12).fill(0),
        250,
        0,
        0,
    ...
    let yearSalaryEmployer = grossToNetWithTotal(
        Array(12).fill(0),
        250,
        0,
        0,
